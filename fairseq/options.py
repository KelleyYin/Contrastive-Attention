...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--max-sentences', '--batch-size', default=2,type=int, metavar='N',
...
def add_optimization_args(parser):
    ...
    group.add_argument('--lr', '--learning-rate', default='0.0005', metavar='LR_1,LR_2,...,LR_N',
    ...
    group.add_argument('--lr-scheduler', default='inverse_sqrt',
...
def add_common_eval_args(group):
    group.add_argument('--path', default="checkpoints/checkpoint_best.pt", metavar='FILE',
                       help='path(s) to model file(s), colon separated')
    group.add_argument("--src_path", default="../test_data/test.ch-en.ch",
...
def add_generation_args(parser):
    ...
    group.add_argument('--print-alignment', default=True,
...
def add_interactive_args(parser):
    ...
    group.add_argument('--buffer-size', default=100, type=int, metavar='N',
...
def add_model_args(parser):
    ...
    group.add_argument(
        '--arch', '-a', default='transformer', metavar='ARCH',
